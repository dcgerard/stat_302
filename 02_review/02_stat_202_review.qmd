...
-   For the examples below, we will use datasets available on the
    [course data page](https://dcgerard.github.io/stat_302/data.html),
...
-   **Exercise**: The Armed Forces Qualifying Test is designed for evaluating
  ...
  the appropriate hypotheses, and run appropriate hypothesis tests.
    ...
    #| echo: false
    #| eval: false
    ex0222 <- read_csv("https://dcgerard.github.io/stat_302/data/ex0222.csv")
    afqt <- ex0222
    afqt %>%
...
-   **Exercise**: Read up on the `ex0330` dataset from the Sleuth3 R package. Determine
  ...
  confidence intervals you derive.
    ...
    #| echo: false
    #| eval: false
    ex0330 <- read_csv("https://dcgerard.github.io/stat_302/data/ex0330.csv")
    ex0330 %>%
...
-   Example: 86 lung cancer patients and 86 controls were interviewed on their
  ...
  <https://data-science-master.github.io/lectures/data/smoke.csv>.
    ```{r}
    #| message: false
    smoke <- read_csv(file = "https://data-science-master.github.io/lectures/data/smoke.csv")
    glimpse(smoke)
    ```
