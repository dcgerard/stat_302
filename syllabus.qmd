...
- Week 6: Chapter 13 (Two-way ANOVA)
- Week 7: Sections 6.3--6.4 and supplemental readings (Multiple Comparisons, Family-wise Error Rate, Bonferroni/Holm, False Discovery Rate, Benjamini-Hochberg).
- Exam 1
- Week 8--9: Chapters 7 and 8 (Simple Linear Regression)
  - This should also be mostly review of Introductory Statistics, so we'll go quick.
- Week 10--12: Chapter 9--11 (Multiple Linear Regression)
- Week 13--14: Chapter 20--21 (Logistic Regression)
- Exam 2
...
- 15% Participation
  ...
  - I'll take of a percentage-point each time I see you reading the news, on social media, playing video games, etc.
- 25% Final Project
- 50% In-class Exams
