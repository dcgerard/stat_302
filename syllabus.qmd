...
- Week 2: Chapters 2 and 3 (*t*-tools and *t*-tools assumptions)
  - This should be mostly review of Introductory Statistics, so we'll go quick.
- Week 3: Chapter 4 (non-parametrics)
- Week 4: Chapter 5 (One-way ANOVA)
- Week 5: Chapter 13 (Two-way ANOVA)
...
- Exam 1
- Week 7: Chapters 7 and 8 (Simple Linear Regression)
  - This should also be mostly review of Introductory Statistics, so we'll go quick.
- Week 8--10: Chapter 9--11 (Multiple Linear Regression)
- Week 11: Chapter 20--21 (Logistic Regression)
- Week 13: Sections 19.3--19.4 (Chi-squared and Fisher's Exact Tests)
- Exam 2
- Week 14: Chapter 17 (PCA)
...
- 25% Final Project
- 50% In-class Exams (likely 2 of them)
