...
-   We won't cover what it does exactly. But you should always use it over Bonferroni. (Holm is the default in R's `p.adjust()`).
...
- Dunnett: All comparisons versus a single reference value.
