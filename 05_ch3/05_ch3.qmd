...
#| message: false
library(patchwork)
case0201_qqplot <- read_csv("https://dcgerard.github.io/stat_302/data/case0201.csv")
beak78 <- case0201_qqplot$Depth[case0201_qqplot$Year == 1978]
case0301_qqplot <- read_csv("https://dcgerard.github.io/stat_302/data/case0301.csv")
rainun <- case0301_qqplot$Rainfall[case0301_qqplot$Treatment == "Unseeded"]
```
...
#| fig-height: 2
#| fig-width: 3
ggplot(data.frame(x = beak78), aes(x = x)) +
...
#| fig-height: 2
#| fig-width: 3
ggplot(data.frame(x = rainun), aes(x = x)) +
...
```{r}
#| label: qqplot-beak
ggplot(data.frame(x = beak78), aes(sample = x)) +
  geom_qq() +
  geom_qq_line()
```
...
ggplot(data.frame(x = rainun), aes(sample = x)) +
  geom_qq() +
  geom_qq_line()
```
